...
nA <- cd$n1
levels <- cd[[4]]
P <- prod(levels) #Only 1173 realized patter
...
ptm <- proc.time()
Zchain_sadinle <- BRL::bipartiteGibbs(cd, nIter = iter)
Zchain_sadinle[[1]] <- Zchain_sadinle[[1]][, -(1:burn)]
...
# as_image(results_image, file = "../notes/figures/el_salvador/time_table_big_P.png")
