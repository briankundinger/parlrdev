...
```{r}
samesies <- Zhat_resolved == Zhat_sadinle[[1]]
compare_probs <- Zhat_parlr[[2]][samesies] - Zhat_sadinle[[2]][samesies]

hist(compare_probs)

sum(Zhat_parlr[[1]] == Zhat_sadinle[[1]])/nB
sum(Zhat_resolved== Zhat_sadinle[[1]])/nB
```
