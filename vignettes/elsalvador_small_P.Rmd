...
Zchain_fabl <- BKSimple_hash_discount(cd, S = S, R = R, show_progress = T, all_patterns = FALSE, lag = lag)
#Zchain_empirical <- BKSimple_hash2(cd, S = S, R = R, show_progress = T, all_patterns = FALSE, empirical = TRUE)
