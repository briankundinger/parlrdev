...
#saveRDS(df, "../data/speed_sim_fixed_nB")
df <- readRDS("../data/speed_sim_fixed_nB")
...
ggsave(filename = "../notes/figures/speed_plot_fixed_nB_new.png", plot = speed_plot_fixed_nB)
