...
n1_vals <- c(500, 1000, 2000, 3000, 4000, 5000)
n2 <- 500
show_progress <- T
fast = F
...
for(i in seq_along(n1_vals)){
  ...
  #parlr method
  ptm <- proc.time()
  Zchain <- BKSimple_hash2(cd, all_patterns = F)
...
# ggsave(filename = "../notes/figures/speed_plot_fixed_nB.png", plot = speed_plot_fixed_nB)
