...
for(i in seq_along(n1_vals)){
  ...
  Zchain <- fabl_gibbs(cd, all_patterns = all_patterns)
...
saveRDS(df, "../data/speed_sim2")
#df <- readRDS("../data/speed_sim2")
...
ggsave(filename = "../notes/figures/sadinle_speed_plot2_new.png",
       plot = speed_plot)
