...
```{r load_hash}
#saveRDS(cd, file = "../data/ntlcs_hash3_new_combine.rds")
#cd <- readRDS(file = "../data/ntlcs_hash3.rds")
```
...
png(file="../notes/figures/nltcs/postprob_hist3.png")
hist(post_probs)
dev.off()
...
ggsave("../notes/figures/nltcs/overlap_posterior3.png")
```
...
ggsave("../notes/figures/nltcs/m_posterior3.png")
