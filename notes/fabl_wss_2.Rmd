...
- Multiple organizations have documented casualties. El Rescate - Tutela Legal (ERTL) contains $n_A = 4420$ records, and  Salvadoran Human Rights Commission (CDHES) contains $n_B =  1323$ records.

- We need to find duplicates across separate datafiles to accurately estimate *documented identifiable deaths* (DID)
