...
I reran everything with only 3 levels for first name, last name, and day, and only 2 levels for everything else. This yields $P = 432$, and results stay basically the same. 
