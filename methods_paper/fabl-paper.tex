...
There have been extensions to directly model the data in this literature at combining many databases, however, we do not review this as it's not directly comparable with the situation of bipartite record linkage \citep{steorts_bayesian_2016, steorts_entity_2015, zanella_flexible_2016, marchant_distributed_2019, tancredi_2015_regression, }.

\paragraph{Classification Approaches} 

\textcolor{red}{Now state the related work here in this literature and common approaches.}

\textcolor{red}{ATTN: These are just notes and need to be edited}

\begin{enumerate}
\item The most common approach is FS. 
\item ``A number of approaches directly model the information contained in the datafiles (Fortini et al., 2002; Matsakis, 2010; Liseo and Tancredi, 2011; Tancredi and Liseo, 2011; Gutman et al., 2013; Steorts et al., 2013), which requires crafting specific models for each type of field in the datafile, and are therefore currently limited to handle nominal categorical
fields, or continuous variables modeled under normality." [Update this literature] 
\item Classification. ``A more common way of tackling this problem is to see it as a traditional classification
...
2001; Bilenko et al., 2003; Christen, 2008; Ventura et al., 2013)." [Update this literature] 
\end{enumerate}

\section{The Fellegi Sunter Approach to Record Linkage}

I think this should be reviewed so that the paper is more clear. 
