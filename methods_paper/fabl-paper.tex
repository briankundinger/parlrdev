...
In this section, we deviate from the approach of \cite{}, and propose a more scalable prior on the matching labelings $\bm{Z}.$ 
...
\textcolor{red}{Lay out Brian's prior here.}
