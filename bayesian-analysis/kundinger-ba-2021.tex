...
\begin{frontmatter}
\title{Bayesian Graphical Entity Resolution using Exchangeable Random Partition Priors}
%\title{A Sample Document\thanksref{T1}}
%\thankstext{T1}{<thanks text>}
\runtitle{Entity Resolution using Exchangeable Random Partition Priors}
