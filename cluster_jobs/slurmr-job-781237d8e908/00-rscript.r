...
JOB_NAME  <- "slurmr-job-781237d8e908"
...
tcq({
  INDICES <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/mc.cores.rds")
})
tcq({
  seeds <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/seeds.rds")
})
...
saveRDS(ans, sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-781237d8e908/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
