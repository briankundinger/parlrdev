...
JOB_NAME  <- "slurmr-job-613e48cc61cd"
...
tcq({
  INDICES <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/mc.cores.rds")
})
tcq({
  seeds <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/seeds.rds")
})
...
saveRDS(ans, sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-613e48cc61cd/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
