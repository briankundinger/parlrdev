...
JOB_NAME  <- "slurmr-job-6df659f30d39"
...
tcq({
  INDICES <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/mc.cores.rds")
})
tcq({
  seeds <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/seeds.rds")
})
...
saveRDS(ans, sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6df659f30d39/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
