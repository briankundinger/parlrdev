...
JOB_NAME  <- "slurmr-job-6fa83f763bf8"
...
tcq({
  INDICES <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/INDICES.rds")
})
tcq({
  X <- readRDS(sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/X_%04d.rds", ARRAY_ID))
})
tcq({
  FUN <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/FUN.rds")
})
tcq({
  mc.cores <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/mc.cores.rds")
})
tcq({
  seeds <- readRDS("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/seeds.rds")
})
...
saveRDS(ans, sprintf("/home/users/bak47/projects/parlrdev/cluster_jobs/slurmr-job-6fa83f763bf8/03-answer-%03i.rds", ARRAY_ID), compress = TRUE)
