...
\begin{enumerate}	
\item \textcolor{red}{Note that 	$\gamma_{Z_j, j}$ doesn't appear to be defined.}
\item \textcolor{red}{There appears to be no update for $\pi$ in this section.}
...
\textcolor{red}{Some statement regarding $\pi$ needs to go here even if it's that you draw from the same distribution as in the original sampler.}
