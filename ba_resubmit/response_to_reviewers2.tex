...
\reply{We added this sentence in an attempt to address a previous reviewer comment pointing out a conflation between the record itself and the index directing towards that record. With the simplified reference to the two datasets as $A$ and $B$, that material now reads: 
