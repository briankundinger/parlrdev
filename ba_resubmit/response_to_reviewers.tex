...
We thank the Editor, the AE, and the reviewer for their feedback, and pointing out our strengths of the paper and areas that we can improve the quality of our paper. We have revised our paper in the abstract and introduction as to make our contributions more clear in relation to prior work.  Furthermore, we have carefully edited the paper to address issues that were pointed out by the Editorial Board.
	...
	\reply{
We appreciate these comments, and have done our utmost to address the ones listed by yourself and the AE. Furthermore, we have carefully gone through the paper ourselves, where we have corrected other issues with notation, typos, and various inconsistencies.
	}
	...
	\reply{
$I_{obs}()$ is now defined. We have defined $n_{12}(Z)$ at its first occurrence (and removed the error with $D$). We have checked for other notational inconsistencies.
	}
...
\pointRaised{E}{%
	...
	\reply{%
We agree with this comment, and we have removed this example as it does not add to the paper.
}
...
\reply{	
	...
	\item As I said, I do not believe that we, as reviewers, were able to uncover all the problems, and I strongly encourage the authors to do their part, as they should, to improve the presentation and eliminate all typos and inconsistencies. \textbf{This has been done by all authors.} 
...
\reply{%
	Our missingness assumptions and the definition of $I_{obs}()$ have been added right before Section 2.1.
}
...
\reply{%
	We have removed the $\Phi$ notation, using the parameters $\bm{m}$ and $\bm{u}$ throughout the paper.
}
...
\reply{%
	We have changed $w_{ij}$ to $w_{z_j, j}$ in the pmf for $\Gamma_{.j}$ and the full conditional for $Z_j$. We have updated additional parts of the paper with this revision. We have been sure that “$n_1+1$” has been changed to “$n_1+ j$” throughout the paper.
}
...
\reply{%
	The lemma now includes assumptions and definitions for all variables used within the statement.
}
...
\reply{%
	We have updated the Figure with these results. Since it is presented alongside NPV and PPV, for which values close to 1 indicate strong performance, we have presented decision rate (DR) results, instead of rejection rate (RR) results. Additionally, this analysis was moved to the appendix so the main body more clearly focuses on our contributions.
}
...
\reply{%
	...
	\reply{%
	Thank you for your positive feedback regarding our paper. We have clarified that our work is an extension of Sadinle (2017) for enhanced speed and scalability. We have tried to make this more clear in both the abstract, introduction, and conclusion. We have also condensed the discussion of Fellegi and Sunter and moved the explanation of the Bayes estimate to the Appendix; we hope that these changes allow the reader to more clearly see our contributions. }
