...
\reply{%
	\textbf{Our missingness assumptions and the definition of $I_{obs}()$ have been added near end of Section 3.} \textcolor{red}{Think about where best to put this.} \textcolor{blue}{I put this somewhere; feel free to move it if you don't like it!}
}
...
\reply{%
	...
	Thank you for your positive feedback regarding our paper. We have clarified that we are motivation by the work of Sadinle and computational considerations. We have tried to make this more clear in both the abstract, introduction, and conclusion.}
		\textcolor{red}{BEKA/JERRY: I think this reviewer wants us to explicitly mention Sadinle in the abstract. I think I had that originally, but we removed it. 
	}
