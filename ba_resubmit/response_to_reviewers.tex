...
\reply{%
	\textbf{Our missingness assumptions and the definition of $I_{obs}()$ have been added near end of Section 3.} \textcolor{red}{Think about where best to put this.}
}
...
\reply{%
	...
	\reply{%
		\textcolor{red}{BEKA/JERRY: I think this reviewer wants us to explicitly mention Sadinle in the abstract. I think I had that originally, but we removed it. Please advise on the best way to address this comment.}
	}
...
\textcolor{blue}{Brian: These are just some suggestions that I have, so we can chat through these in case you don't agree! I have these marked up on the paper itself to help you more easily make the changes.}
...
\begin{itemize}
	\item \textcolor{red}{I don't really understand what you want me to change there.}
\end{itemize}
...
\begin{itemize}
	\item \textcolor{red}{I don't really understand what you want me to change there. Its not really possible to say the Sadinle doesn't work for X many records in any precise way, because it depends on the number of comparison fields and the number of records in each dataset. Also, I don't know how to say exactly when something is "too slow" in a precise way.}
\end{itemize}
