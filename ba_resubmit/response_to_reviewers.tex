...
\reply{%
\textcolor{red}{\todo We should meet specifically to talk about how to best present the Gibbs Sampler. I think it be good to move as much of it as possible (at least the messy math and derivations) into the appendix.}
...
\reply{%
	\textcolor{red}{I don't fully understand the first part of the comment}
...
\reply{%
	...
	\textcolor{red}{I think this is clear in the paper, so I did not add anything to the actual text.} 
}
