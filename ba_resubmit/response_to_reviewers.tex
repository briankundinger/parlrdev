...
\reply{%
	We thank the Editor, the AE, and the reviewer for their feedback. We have made an effort to make it more clear our contributions in this work as opposed to previous work. Furthermore, we have carefully edited the paper to address issues that were pointed out by the Editorial Board.
		...
		\begin{enumerate}
		\item We have included an explanation of our missingness assumptions along with the defintion of $I_{obs}.$ Additionally, we have defined $n_{12}(Z)$ at its first occurance.
...
\pointRaised{E}{%
	...
	\reply{%
We agree with this comment, and we have removed this example as it does not add to the paper. Furthermore, we have gone through the paper to improve the overall exposition and clarity of the writing.\todo
}
...
\reply{%
	We have included the details for integrating out $\pi$ in the appendix. \todo
}
...
\reply{%
	Participants can be added in later cohorts. This has been clarified in the paper. \todo
}
