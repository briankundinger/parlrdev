...
\reply{%
We thank the reviewers for identifying this oversight, and have defined the notation. \todo
}
...
indices of the sum contained in the brackets.
		...
		\reply{%
We thank the reviewers for identifying this oversight, and have corrected the expression. \todo
}
\pointRaised{R1}{%
...
may be more clear if you replace i with $z_j$, as in $w_{z_j j}$. I believe that “$n_1+1$” should be “$n_1+ j$” in several places.
	...
	\reply{%
	I would recommend fixing this to make it more clear since this is the AE.
	}
