...
\begin{document}
	...
	\reply{E}{%
	\textbf{We agree with this comment, and we have removed this example as it does not add to the paper. Furthermore, we have gone through the paper to improve the overall exposition and clarity of the writing.} \todo
	}
