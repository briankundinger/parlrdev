...
\reply{%
	We thank the Editor, the AE, and the reviewer for their feedback. We have made an effort to make it more clear our contributions in this work as opposed to previous work. Furthermore, we have carefully edited the paper to address issues that were pointed out by the Editorial Board.
		...
		\begin{enumerate}
		\item \textcolor{red}{I'm unsure where I should put our missing at random (MAR) assumption, and therefore also unsure where to put the definition of $I_{obs}$}
...
\reply{%
	\textcolor{red}{I'm unsure where I should put our missing at random (MAR) assumption, and therefore also unsure where to put the definition of $I_{obs}$}
}
...
\reply{%
\textcolor{red}{We should meet specifically to talk about how to best present the Gibbs Sampler}
