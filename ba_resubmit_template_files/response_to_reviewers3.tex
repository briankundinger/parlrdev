...
\section{Associate Editor Comments}
	...
	\reply{
	The reviewer is correct that the distinction does not matter between MCAR and MAR. We have included the following explanation of missingness in Section 2.
