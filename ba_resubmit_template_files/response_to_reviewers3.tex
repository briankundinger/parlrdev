...
\section{Associate Editor Comments}
	...
	\reply{
	\textcolor{teal}{The reviewer is correct that the distinction does not matter between MCAR and MAR. We have included the following explanation of missingness in Section 2.}
...
\reply{%
	...
	We have revised the derivation of the full conditional distribution of $Z_j$, separately handling the case when $B_j$ has a match and when it does not. Refer to \textcolor{teal}{Supplement}~A for this extended derivation.
	}
