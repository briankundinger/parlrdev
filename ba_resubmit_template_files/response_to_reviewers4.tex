...
\reply{The Associate Editor is correct that $\Gamma_{n_A+j, j}$ is not defined under this notation. We had attempted to remove all instances in which this notation might be implied, but we did not catch them all. We thank the AE for their thoughtful suggestions in this regard.
}
...
\reply{We believe that the revised notation addresses this concern.
}
