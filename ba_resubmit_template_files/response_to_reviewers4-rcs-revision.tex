...
\textcolor{red}{Brian: change E to AE. Make sure to address the reviewer as AE (many typos below). Address the questions/comments of the Editor above. Please separate out major comments with minor comments as the AE did.}
